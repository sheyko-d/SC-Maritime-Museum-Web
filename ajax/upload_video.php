...
// Check file size
if ($_FILES["file"]["size"] > 155555555) {
    $error = "Sorry, your file is too large.";
    $success = false;
}
// Allow certain file formats
if ($imageFileType != "mp4" && $imageFileType != "avi" && $imageFileType != "mov" && $imageFileType != "mpg" && $imageFileType != "mpeg" && $imageFileType != "mkv") {
    $error = "Sorry, only video files are allowed.";
    $success = false;
}
// Upload the file
if ($success) {
