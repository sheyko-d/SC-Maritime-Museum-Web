...
<div id="page-" class="col-md-4 col-md-offset-4">
	...
	<form class="form loginform" method="POST" action="authenticate.php">
			<div style="text-align:center">
				<img src="assets/images/icon.png" width="30%" style="margin-top:25%" />
			</div>
...
if (isset($_SESSION['login_failure'])) {?>
				...
				<?php }?>
				<button type="submit" class="btn btn-success loginField" style="background-color:#8A9FB4;border-color:#7a8da0">Login</button>
			</div>
		</div>
	</form>
</div>
